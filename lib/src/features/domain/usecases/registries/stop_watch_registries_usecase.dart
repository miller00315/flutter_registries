...
class StopWatchRegistriesUsecase implements Usecase<Unit, NoParams> {
  final RegistriesRepositoryBase _repository;

  StopWatchRegistriesUsecase(this._repository);

  @override
  Future<Either<Failure, Unit>> call(NoParams params) async {
    return await _repository.stopWatchRegistries();
  }
}
